...
def Dump():
    ...
    if os.path.exists('result/' + PACKAGE_NAME + '.dex'):
        print(
            '[*] Success >> ' + 'result/' + PACKAGE_NAME + '.dex')
    # 清理环境
...
def Useage():
    Title()
    print(
        '[*] Useage: bunpacker.py jiagu.apk')
    print(
        '[*] 1.Before Running ,make sure a rooted Android system has been connected to your PC')
    print(
        '[*] 2.Only for testing,Do not be evil !')
